        ...
        <>
            <header className="py-4 sm:py-6 md:py-8 text-sky-900 leading-10">
                ...
                <div className="grid grid-rows-2 grid-cols-3 gap-8 mb-8">
                    <p className="col-span-2">歡迎您進入銘傳大學語音檢索課程系統，此系統只需用語音輸入的方式，即可找到課程資訊以及老師的課表，在使用的過程中我們也會引導您如何去使用我們的系統。將您在查詢時所花費的時間大幅減少，並且迅速地取得您想要的資訊，這便是我們製作這網站的初衷。請按下方的「開始選課」按鈕進入語音輸入頁面進行查詢。</p>
                    <div />
                    <div />
                    <div />
                </div>
                ...
                <div className="text-gray-900 text-lg leading-8">
                    <ul className="list-inside list-disc marker:text-sky-300">
                        ...
                        <li>可決定將查詢結果顯示部分所要的資訊。 (如: 只顯示該科目的代號或班級代號等等。)</li>
